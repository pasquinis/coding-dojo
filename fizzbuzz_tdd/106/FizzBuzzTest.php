...
class FizzBuzzTest extends \PHPUnit_Framework_TestCase
{
    ...
    public function testWhenISayAMultipleOf3TheResponseIsFizz()
    {
        $fizz = new FizzBuzz();
    ...
    public function testWhenISayAMultipleOf5TheResponseIsBuzz()
    {
        $fizz = new FizzBuzz();
        $this->assertEquals('Buzz', $fizz->say(5*2));
    }

    public function testWhenISayAMultipleOf5And3TheResponseIsFizzBuzz()
    {
        $fizz = new FizzBuzz();
        $this->assertEquals('FizzBuzz', $fizz->say(5*3));
    }
}
